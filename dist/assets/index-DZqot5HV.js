...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ki,depthTest:!1,depthWrite:!1})}function Mx(r,e,t){return new vi({name:"SphericalGaussianBlur",defines:{SAMPLES:_x,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:xl(),fragmentShader:`
