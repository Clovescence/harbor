...
#define LOW_PRECISION`),e}const Ov={[No]:"SHADOWMAP_TYPE_PCF",[ua]:"SHADOWMAP_TYPE_VSM"};function Bv(r){return Ov[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const zv={[Jr]:"ENVMAP_TYPE_CUBE",[Vs]:"ENVMAP_TYPE_CUBE",[ml]:"ENVMAP_TYPE_CUBE_UV"};function kv(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":zv[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const Gv={[Vs]:"ENVMAP_MODE_REFRACTION"};function Hv(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":Gv[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Vv={[ed]:"ENVMAP_BLENDING_MULTIPLY",[wm]:"ENVMAP_BLENDING_MIX",[Rm]:"ENVMAP_BLENDING_ADD"};function Wv(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":Vv[r.combine]||"ENVMAP_BLENDING_NONE"}function Xv(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Yv(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Bv(t),c=kv(t),u=Hv(t),d=Wv(t),f=Xv(t),h=Cv(t),_=Pv(s),g=i.createProgram();let p,m,E=t.glslVersion?"#version "+t.glslVersion+`
